...
const rectanglesOverlap = (a, b, buffer = 0) => {
  return !(a.left + a.width + buffer <= b.left || b.left + b.width + buffer <= a.left || a.top + a.height + buffer <= b.top || b.top + b.height + buffer <= a.top);
};
const rawSlides = [{
  id: 1,
  text: "Coucou ! Je voulais t'écrire une lettre au final, mais tu connais mon écriture...",
  typewriter: true
}, {
  id: 2,
  ...
  id: 3,
  text: "Pour ma copine d'amour, Élise 💖",
  typewriter: true,
  photos: ["photo_01.JPG", "photo_02.jpg", "photo_03.jpg"]
}, {
  id: 4,
  text: "T'es vraiment la personne la plus importante pour moi, et je suis tellement, tellement heureux de t'avoir trouvée",
  typewriter: true,
  photos: ["photo_04.JPG", "photo_05.JPG", "photo_06.JPG"]
}, {
  id: 5,
  text: "T'es la première pensée qui me traverse la tête le matin, et la dernière quand je me couche",
  typewriter: true,
  photos: ["photo_07.JPG", "photo_08.JPG", "photo_09.JPG"]
}, {
  id: 6,
  text: "Quand j'ai quelque chose de nouveau dans ma vie, c'est toujours toi la première personne à qui j'ai envie de le dire, et quand je pense à toi, j'ai ce sourire un peu bête",
  typewriter: true,
  photos: ["photo_10.JPG", "photo_11.JPG", "photo_12.JPG"]
}, {
  id: 7,
  text: "Tu me rends tellement heureux, et t'es tellement attentionnée, douce (dans tous les sens du terme) et mignonne 💗",
  typewriter: true,
  photos: ["photo_13.JPG", "photo_14.JPG", "photo_15.JPG"]
}, {
  id: 8,
  text: "Même quand on se prend la tête, tu restes toujours ma princesse d'amour, et je t'aimerai pour toujours",
  typewriter: true,
  photos: ["photo_16.jpg", "photo_17.JPG", "photo_18.JPG"]
}, {
  id: 9,
  text: "J'adore à quel point t'es motivée, déterminée (ou inflexible, ou tête dure, comme tu veux) dans ce que tu fais, et tu veux réussir, ce qui me rend fier d'être avec toi",
  typewriter: true,
  photos: ["photo_19.JPG", "photo_20.jpg", "photo_21.JPG"]
}, {
  id: 10,
  text: "Aussi parce que t'es super belle (je sais pas si je l'ai dit), et j'adore qu'on puisse rire de tout (ou presque)",
  typewriter: true,
  photos: ["photo_22.JPG", "photo_23.JPG", "photo_24.jpg"]
}, {
  id: 11,
  text: "Tu essaies même les trucs que j'aime, juste pour me faire plaisir, et tu me rends tellement heureux, je veux passer le reste de ma vie avec toi",
  typewriter: true,
  photos: ["photo_25.JPG", "photo_26.jpg", "photo_27.JPG"]
}, {
  id: 12,
  text: "Quand je te regarde, je ressens trop d'amour dans le ventre, et j'ai juste envie de t'embrasser 💘",
  typewriter: true,
  photos: ["photo_28.JPG", "photo_29.JPG", "photo_30.JPG"]
}, {
  id: 13,
  text: "T'es la meilleure copine que je pouvais rêver d'avoir, et je suis super reconnaissant pour ces 8 mois qu'on a passés ensemble",
  typewriter: true,
  photos: ["photo_31.JPG", "photo_32.JPG"]
}, {
  id: 14,
  text: "J'espère qu'il y en aura encore des dizaines d'autres, toujours avec toi, et je t'aime plus que tout 💞",
  typewriter: true,
  photos: ["photo_33.jpg", "photo_34.jpg"]
}, {
  id: 15,
  text: "- Yasser",
  typewriter: true,
...
const PhotoStage = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    ref: leftZoneRef,
    className: "photo-zone photo-zone-left"
  }, /*#__PURE__*/React.createElement(AnimatePresence, null, layout.left.map(item => /*#__PURE__*/React.createElement(motion.figure, {
    key: item.key,
    ...
    ref: rightZoneRef,
    className: "photo-zone photo-zone-right"
  }, /*#__PURE__*/React.createElement(AnimatePresence, null, layout.right.map(item => /*#__PURE__*/React.createElement(motion.figure, {
    key: item.key,
    className: "photo-card",
    style: {
      width: `${item.width}px`,
...
const UnifiedLoveApp = () => {
  ...
  const startSlideTransition = useCallback(targetIndex => {
  ...
  const repositionFloatingButton = useCallback(() => {
    ...
    const fitsViewport = pos => pos.left >= margin && pos.top >= margin && pos.right <= innerWidth - margin && pos.bottom <= innerHeight - margin;
    ...
    while (attempt < 90) {
      ...
      const candidateLeft = range ? range.start + (available > 0 ? Math.random() * available : 0) : margin + Math.random() * available;
      ...
      const collides = avoidZones.some(zone => !(candidate.right < zone.left || candidate.left > zone.right || candidate.bottom < zone.top || candidate.top > zone.bottom));
  ...
  const handleControlsPointerDown = useCallback(event => {
  ...
  const formattedText = isTyping ? typedText.replace(/\n/g, "<br>") : highlightImportant(currentSlide.text, currentSlide.important);
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    photos: currentSlide.decoratedPhotos,
    seed: stageSeed,
    onOpenLightbox: handleOpenLightbox
  }), /*#__PURE__*/React.createElement("section", {
    className: "phrase-zone",
    "aria-live": "polite",
    "aria-atomic": "true"
  ...
  }), isTyping && /*#__PURE__*/React.createElement("span", {
    ...
    role: "toolbar",
    "aria-label": "Contr\xF4les du diaporama",
    style: controlsStyle,
    ...
    "aria-label": "Vitesse de la machine \xE0 \xE9crire",
  ...
  }, "Musique \uD83C\uDFB5"), /*#__PURE__*/React.createElement("span", {
    className: "love-bgm-track",
    "aria-live": "polite"
  }, currentBgmTitle ? `Lecture : ${currentBgmTitle}` : "Lecture : —")), /*#__PURE__*/React.createElement("div", {
    className: "love-control-col love-slider-col"
  }, /*#__PURE__*/React.createElement("input", {
    id: "bgmVolumeRange",
    type: "range",
    ...
    htmlFor: "bgmVolumeRange",
    className: "love-control-cap"
  }, "Musique (", displayBgmVolume, "%)")), /*#__PURE__*/React.createElement("div", {
    className: "love-control-col love-button-col"
  }, /*#__PURE__*/React.createElement("button", {
    type: "button",
  ...
  }, "Turbo")), /*#__PURE__*/React.createElement("div", {
    className: "love-control-col love-button-col"
  }, /*#__PURE__*/React.createElement("button", {
    type: "button",
    ...
    className: "love-control-col love-progress-col"
  }, /*#__PURE__*/React.createElement("div", {
    className: "love-progress-wrap"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    id: "progressText",
    className: "love-progress-text",
    "aria-live": "polite"
  }, currentIndex + 1, " / ", totalSlides)))), /*#__PURE__*/React.createElement("footer", {
    className: "signature"
  }, "made with \uD83D\uDC96 by Yasser"), /*#__PURE__*/React.createElement(AnimatePresence, null, lightboxPhoto && /*#__PURE__*/React.createElement(motion.div, {
  ...
  }, /*#__PURE__*/React.createElement("strong", null, "Souvenir agrandi"), /*#__PURE__*/React.createElement("span", {
    className: "photo-lightbox-hint"
  }, "Double-clique ou tape en dehors pour fermer"))))), /*#__PURE__*/React.createElement("button", {
    type: "button",
